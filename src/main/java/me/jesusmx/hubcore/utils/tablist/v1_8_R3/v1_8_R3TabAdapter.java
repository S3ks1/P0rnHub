package me.jesusmx.hubcore.utils.tablist.v1_8_R3;
...
import me.jesusmx.hubcore.utils.tablist.shared.TabAdapter;
import me.jesusmx.hubcore.utils.tablist.shared.client.ClientVersionUtil;
import me.jesusmx.hubcore.utils.tablist.shared.skin.SkinType;
...
public class v1_8_R3TabAdapter extends TabAdapter {
    ...
    public TabAdapter hideRealPlayers(Player player) {
        for (Player target : PornHub.getInstance().getOnlinePlayers()) {
